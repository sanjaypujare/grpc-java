...
public class ReferenceCountingMapTest {
  ...
  private static class MyValue implements Closeable {
  ...
  private static class MyResourceDef implements ReferenceCountingMap.ResourceDefinition<Integer, MyValue> {
    Integer key;
  ...
  @Test
  public void referenceCountingMap_getAndRelease() throws InterruptedException {
  ...
  @Test
  public void referenceCountingMap_() throws InterruptedException {
    ReferenceCountingMap<Integer, MyValue> map = new ReferenceCountingMap<>();
