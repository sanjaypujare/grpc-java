...
public class SdsProtocolNegotiatorsTest {
  ...
  @Test
  public void clientSdsHandler_addLast() throws IOException, InterruptedException, TimeoutException, ExecutionException {
    ...
    SslContextProviderSupplier sslContextProviderSupplier =
        new SslContextProviderSupplier(upstreamTlsContext, new TlsContextManagerImpl(bootstrapInfoForClient));
