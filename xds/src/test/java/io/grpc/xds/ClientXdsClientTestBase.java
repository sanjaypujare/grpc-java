...
import static io.grpc.xds.ClientXdsClient.TYPE_URL_HTTP_CONNECTION_MANAGER;
...
public abstract class ClientXdsClientTestBase {
  ...
  Listener buildListenerWithFilterChain(
    ...
    FilterChain filterChain =
        buildFilterChain(
            FilterChainMatch.newBuilder().addAllApplicationProtocols(Arrays.<String>asList()).build(),
            CommonTlsContextTestsUtil.buildTestDownstreamTlsContext(
