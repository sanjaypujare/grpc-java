...
gcloud beta container clusters create ${CLUSTER_NAME} --cluster-version=1.18.10-gke.1500 \
  ...
  --zone=${CLUSTER_ZONE} --scopes=https://www.googleapis.com/auth/cloud-platform  --enable-ip-alias \
